...
function SheetRight({ curentPages, data, setShowTippyName, id_account, ps, setData }) {
  ...
  const handleOneChange = () => {
    ...
    axios
      .post(`${SERVER_PORT}/admin/nha-hang/edit/children`, {
        ps,
        id_account,
      ...
      .then((res) => {
        if (res.data) {
          axios
            .get(`${SERVER_PORT}/admin/nha-hang/allpages`, {
              params: {
  ...
  return (
    <>
      <div className={cx('header')}>
        ...
        <span className={cx('header_span')}>Thông Tin Nhà Hàng</span>
      </div>
      <div className={cx('body')}>
        <div className={cx('children')}>
          <span className={cx('span')}>Tên Nhà Hàng</span>
