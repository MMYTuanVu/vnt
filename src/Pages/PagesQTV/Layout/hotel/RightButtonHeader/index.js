      ...
      render={(attrs) => (
        <div className={cx('right_nab')} tabIndex="-1" {...attrs}>
          ...
          <div className={cx('hotel_country')}>
            <span className={cx('hotel_country_span')}>KS Theo khu vực</span>
          ...
          <div className={cx('hotel_pressent')}>
            <span className={cx('hotel_pressent_span')}>Khách sạn đang làm</span>
            <SpanButton children="Xem khách sạn" square width="100px" height="22px" fontSize="1.3rem" />
          </div>
          <div className={cx('hotel_pressent')}>
            <span className={cx('hotel_pressent_span')}>Khách sạn đã làm</span>
            <SpanButton children="Xem khách sạn" square width="100px" height="22px" fontSize="1.3rem" />
          </div>
          <div className={cx('hotel_pressent')}>
