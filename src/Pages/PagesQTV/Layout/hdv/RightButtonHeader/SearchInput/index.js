...
function SearchInput({ id_account, ps }) {
  ...
  useEffect(() => {
    if (valueData != '') {
      setShowLoad(true);
      axios
        .get(`${SERVER_PORT}/admin/search/hdv`, {
          params: {
                  ...
                  <div className={cx('row')} key={index}>
                    ...
                    <div className={cx('name')}>
                      <div className={cx('name_prent')}>
                        <span className={cx('name_nm_title')}>Tên HDV:</span>
                        <span className={cx('name_nm')}>{datax.name}</span>
                      </div>
                      <div className={cx('name_prent')}>
                        <span className={cx('name_nm_title')}>Ngoại Ngữ:</span>
                        <span className={cx('name_nm')}>{datax.language}</span>
                      </div>
                    </div>
                  </div>
                ))}
